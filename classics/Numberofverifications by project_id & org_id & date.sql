SELECT
	...
	TO_CHAR(identity_accesses.completed_at, 'YYYY-MM-DD') AS "identity_accesses_completed_at"
FROM
	identity_accesses
...
WHERE
	TO_CHAR(identity_accesses.completed_at, 'YYYY-MM-DD') >= '2022-06-01'
	AND TO_CHAR(identity_accesses.completed_at, 'YYYY-MM-DD') < '2022-07-01'
GROUP BY
