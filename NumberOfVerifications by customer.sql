...
WHERE
	...
	AND TO_CHAR(identity_accesses.created_at, 'YYYY-MM-DD') >= '2022-03-03'
	AND TO_CHAR(identity_accesses.created_at, 'YYYY-MM-DD') < '2022-04-03'
	--AND organizations.id IN (972)
GROUP BY
	organizations.id,
	organizations.name,
	environment_type,
